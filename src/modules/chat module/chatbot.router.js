...
router.route('/readChat/:userId').get(authchatCon.readChat)

router.route('/updateChat/:userId').patch(auth,role("ADMIN"),chatCon.updateChat);

router.route('/deleteChat/:userId').delete(auth,role("ADMIN"),chatCon.deleteChat);
